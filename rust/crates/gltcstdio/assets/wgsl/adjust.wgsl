...
fn adjust(pos: vec2<f32>, outPos: vec2<f32>, brightness_2: f32, contrast_2: f32, luminosity_2: f32, gamma_3: f32, saturation_2: f32, hue_2: f32, tint_4: vec4<f32>, vignette_intensity: f32, vignette_hardness: f32, vignette_color: vec4<f32>, vignette_transform: mat3x3<f32>) -> vec4<f32> {
    var pos_1: vec2<f32>;
    ...
    let _e56 = hue_3;
    let _e57 = tint_5;
    let _e58 = adjustColor(_e50, _e51, _e52, _e53, _e54, _e55, _e56, _e57);
    col_4 = _e58;
