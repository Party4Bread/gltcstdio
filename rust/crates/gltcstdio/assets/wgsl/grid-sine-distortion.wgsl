...
fn gridSineDistortion(uv: vec2<f32>, outPos: vec2<f32>, intensity: f32, modelTransform: mat3x3<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    ...
    let _e23 = v;
    d = length(_e23);
    let _e27 = intensity_1;
    let _e29 = v;
    let _e35 = v;
    delta = (((10f * _e27) * cos((_e29.x * 3.1415927f))) * cos((_e35.y * 3.1415927f)));
    let _e42 = modelTransform_1;
    let _e43 = v;
    let _e44 = delta;
    let _e45 = v;
    let _e48 = tf(_e42, (_e43 + (_e44 * _e45)));
    u_2 = _e48;
    let _e49 = u_2;
    let _e53 = global.U[0];
    let _e56 = u_2;
