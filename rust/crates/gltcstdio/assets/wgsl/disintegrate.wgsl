...
fn disintegrate(uv: vec2<f32>, outPos: vec2<f32>, outDim: vec2<f32>, mode_8: i32, sourceBkg_specified: i32, colorBkg: vec4<f32>, regularity: f32, len_1: f32, power: f32, translateVar: f32, scaleVar: f32, angleVar: f32, shadows: f32, minimum: f32, threshold: f32, modelTransform: mat3x3<f32>, randomSeed: f32) -> vec4<f32> {
    ...
    if (_e86 == 1i) {
        ...
        let _e106 = textureSample(t_sourceBkg, samp, _e105);
        local_1 = _e106;
    } else {
        let _e107 = uv_1;
        let _e111 = global.U[0];
        let _e114 = uv_1;
        let _e123 = _mirror_wrap(((vec2<f32>((_e107.x / _e111.x), _e114.y) / vec2(2f)) + vec2(0.5f)));
        let _e124 = textureSample(t_source, samp, _e123);
        local_1 = _e124;
    }
    let _e126 = local_1;
    let _e127 = colorBkg_1;
    let _e128 = mergeColor(_e126, _e127);
    color = _e128;
    let _e130 = N;
    i = -(_e130);
    loop {
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    ...
                    let _e151 = i;
                    let _e152 = j;
                    cc_6 = (_e150 + vec2<f32>(_e151, _e152));
                    let _e156 = cc_6;
                    let _e157 = randomSeed_1;
                    let _e158 = rand2relSeeded(_e156, _e157);
                    rnd_1 = _e158;
                    let _e161 = cc_6;
                    let _e166 = randomSeed_1;
                    let _e169 = sineSurfaceRand2Seeded((vec2(0.2f) + (_e161 * 0.75f)), (_e166 * 2f));
                    rnd2_ = _e169;
                    let _e171 = cc_6;
                    let _e172 = phasing_8;
                    let _e173 = mode_9;
                    let _e174 = getProgress(_e171, _e172, _e173);
                    let _e175 = phasing_8;
                    let _e176 = variability;
                    let _e177 = rnd2_;
                    let _e180 = variability;
                    let _e181 = variability;
                    let _e183 = rnd_1;
                    progress_2 = (_e174 + (_e175 * ((_e176 * _e177.x) + ((_e180 * _e181) * _e183.x))));
                    let _e190 = progress_2;
                    let _e192 = phasing_8;
                    let _e195 = power_1;
                    let _e198 = phasing_8;
                    let _e200 = progress_2;
                    progress_2 = ((pow((abs(_e190) / _e192), (1f / _e195)) * _e198) * sign(_e200));
                    let _e203 = progress_2;
                    let _e204 = phasing_8;
                    let _e205 = minProgress;
                    progress_2 = max(_e203, (_e204 * _e205));
                    let _e208 = progress_2;
                    let _e209 = phasing_8;
                    let _e210 = maxProgress;
                    if (_e208 > (_e209 * _e210)) {
                        let _e213 = phasing_8;
                        progress_2 = _e213;
                    }
                    let _e214 = progress_2;
                    let _e215 = phasing_8;
                    let _e216 = mode_9;
                    let _e217 = getGlobalScaling(_e214, _e215, _e216);
                    globalScaling = _e217;
                    let _e220 = phasing_8;
                    let _e221 = progress_2;
                    intensity = smoothstep(0f, _e220, _e221);
                    let _e225 = rnd_1;
                    let _e229 = intensity;
                    let _e231 = scaleVar_1;
                    let _e236 = globalScaling;
                    cScale = (pow(10f, ((((_e225.x * 0.5f) * _e229) * _e231) * 2f)) * _e236);
                    let _e239 = cc_6;
                    let _e240 = phasing_8;
                    let _e241 = mode_9;
                    let _e242 = getBaseAngle(_e239, _e240, _e241);
                    let _e243 = rnd_1;
                    let _e247 = intensity;
                    let _e249 = angleVar_1;
                    cAngle = (_e242 + (((_e243.y * 3.1415927f) * _e247) * _e249));
                    let _e253 = cc_6;
                    let _e254 = phasing_8;
                    let _e255 = mode_9;
                    let _e256 = getBaseTranslate(_e253, _e254, _e255);
                    let _e257 = rnd_1;
                    let _e258 = intensity;
                    let _e260 = translateVar_1;
                    cTr = (_e256 + (((_e257 * _e258) * _e260) * 4f));
                    let _e266 = cScale;
                    let _e267 = cAngle;
                    let _e270 = cScale;
                    let _e272 = cAngle;
                    ...
                    let _e285 = cTr;
                    let _e287 = cTr;
                    locTr = mat3x3<f32>(vec3<f32>((_e266 * cos(_e267)), (-(_e270) * sin(_e272)), 0f), vec3<f32>((_e276 * sin(_e277)), (_e280 * cos(_e281)), 0f), vec3<f32>(_e285.x, _e287.y, 1f));
                    let _e295 = locTr;
                    let _e296 = u_8;
                    let _e297 = cc_6;
                    let _e301 = ((_e296 - _e297) - vec2(0.5f));
                    relU = (_e295 * vec3<f32>(_e301.x, _e301.y, 1f)).xy;
                    let _e309 = relU;
                    let _e312 = sdRectangle(_e309, vec2(0.5f));
                    d_1 = _e312;
                    let _e314 = cScale;
                    let _e320 = cAngle;
                    let _e325 = cTr;
                    trIntens = ((abs(log(_e314)) + (0.5f * smoothstep(0f, 0.5f, abs(_e320)))) + length(_e325));
                    let _e329 = shadows_1;
                    let _e330 = trIntens;
                    shadowLen = (_e329 * _e330);
                    let _e333 = trIntens;
                    if (_e333 == 0f) {
                        {
                            let _e336 = d_1;
                            if (_e336 < 0f) {
                                let _e339 = modelTransform_1;
                                let _e340 = cc_6;
                                let _e341 = relU;
                                let _e346 = tf(_e339, ((_e340 + _e341) + vec2(0.5f)));
                                let _e350 = global.U[0];
                                let _e353 = modelTransform_1;
                                let _e354 = cc_6;
                                let _e355 = relU;
                                let _e360 = tf(_e353, ((_e354 + _e355) + vec2(0.5f)));
                                let _e369 = _mirror_wrap(((vec2<f32>((_e346.x / _e350.x), _e360.y) / vec2(2f)) + vec2(0.5f)));
                                let _e370 = textureSample(t_source, samp, _e369);
                                color = _e370;
                            } else {
                                let _e371 = d_1;
                                let _e372 = shadowLen;
                                if (_e371 < _e372) {
                                    ...
                                    let _e379 = shadowLen;
                                    let _e380 = d_1;
                                    let _e382 = (_e376.xyz * smoothstep(0f, _e379, _e380));
                                    color.x = _e382.x;
                                    color.y = _e382.y;
                                    color.z = _e382.z;
                                }
                        ...
                        let _e392 = d_1;
                        let _e393 = shadowLen;
                        if ((_e389 > 0f) && (_e392 < _e393)) {
                            let _e396 = color;
                            let _e398 = shadowLen;
                            let _e399 = d_1;
                            let _e401 = vec3(smoothstep(0f, _e398, _e399));
                            local_2 = (_e396 * vec4<f32>(_e401.x, _e401.y, _e401.z, 1f));
                        } else {
                            let _e408 = color;
                            local_2 = _e408;
                        }
                        ...
                        let _e412 = cc_6;
                        let _e413 = relU;
                        let _e418 = tf(_e411, ((_e412 + _e413) + vec2(0.5f)));
                        let _e422 = global.U[0];
                        let _e425 = modelTransform_1;
                        let _e426 = cc_6;
                        let _e427 = relU;
                        let _e432 = tf(_e425, ((_e426 + _e427) + vec2(0.5f)));
                        let _e441 = _mirror_wrap(((vec2<f32>((_e418.x / _e422.x), _e432.y) / vec2(2f)) + vec2(0.5f)));
                        let _e442 = textureSample(t_source, samp, _e441);
                        let _e443 = pixel;
                        let _e446 = pixel;
                        let _e450 = d_1;
                        color = mix(_e410, _e442, vec4(smoothstep((_e443 * 0.75f), (-(_e446) * 0.75f), _e450)));
                    }
                }
                continuing {
                    let _e147 = j;
