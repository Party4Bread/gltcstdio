...
fn stretch(uv: vec2<f32>, outPos: vec2<f32>, intensity: f32, dampening: f32, modelTransform: mat3x3<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    ...
    let _e32 = d;
    let _e37 = tf(_e26, (_e27 * pow(2f, (-(_e29) * max(_e31, _e32)))));
    u_2 = _e37;
    let _e38 = u_2;
    let _e42 = global.U[0];
    let _e45 = u_2;
