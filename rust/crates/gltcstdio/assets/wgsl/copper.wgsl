...
fn copper(pos: vec2<f32>, outPos: vec2<f32>, intensity: f32, count: i32, randomSeed: f32, variability: f32, modelTransform: mat3x3<f32>) -> vec4<f32> {
    var pos_1: vec2<f32>;
    ...
    loop {
        ...
        }
        {
            ...
            newPos = _e138;
            let _e140 = d2min;
            let _e143 = intensity_1;
            if ((_e140 > 0f) && (_e143 > 0f)) {
                {
                    let _e147 = t;
                    let _e148 = minCenter;
                    dd = (_e147 - _e148);
                    radius = 100f;
                    let _e153 = radius;
                    let _e156 = minRadiusModifier;
                    threshold = ((_e153 * 0.01f) * _e156);
                    let _e159 = k_4;
                    let _e160 = threshold;
                    if (_e159 < _e160) {
                        {
                            ...
                            let _e166 = k_4;
                            r = (1f - _e166);
                            let _e169 = intensity_1;
                            let _e173 = r;
                            let _e177 = r;
                            dp = (((_e169 * 2f) * (1f - _e173)) / (0.5f + _e177));
                            let _e181 = newPos;
                            let _e182 = dd;
                            let _e183 = dp;
                            newPos = (_e181 + (_e182 * _e183));
                        }
                    }
                }
            }
