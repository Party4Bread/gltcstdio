...
fn cristalBorder(pos: vec2<f32>, outPos: vec2<f32>, border_4: f32, thickness: f32, sourceDim: vec2<f32>, outDim: vec2<f32>, borderColor: vec4<f32>, variability: f32, randomSeed: f32, modelTransform: mat3x3<f32>, borderTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    let _e100 = voronoiBoundary((_naga_inverse_3x3_f32(_e84) * vec3<f32>(_e86.x, _e86.y, 1f)).xy, 200f, ((_e94 * 2f) * _e97), _e99);
    k_6 = (1f - _e100);
    let _e103 = k_6;
    if (_e103 == 0f) {
    ...
    let _e125 = textureSample(t_source, samp, _e124);
    let _e126 = k_6;
    return mix(_e107, _e125, vec4(_e126));
}
