...
fn sdOctahedron(p_2: vec3<f32>, s: f32) -> f32 {
    var p_3: vec3<f32>;
    var s_1: f32;
    var m: f32;
    var q_1: vec3<f32>;
    ...
    let _e58 = s_1;
    let _e62 = s_1;
    k = clamp((0.5f * ((_e53.z - _e55.y) + _e58)), 0f, _e62);
    let _e65 = q_1;
    let _e67 = q_1;
    let _e69 = s_1;
    let _e71 = k;
    let _e73 = q_1;
    let _e75 = k;
    return length(vec3<f32>(_e65.x, ((_e67.y - _e69) + _e71), (_e73.z - _e75)));
}

fn sdf(p_4: vec3<f32>, roundness: f32) -> f32 {
    var p_5: vec3<f32>;
    var roundness_1: f32;
    ...
    let _e11 = p_5;
    let _e14 = sdBox(_e11, vec3(0.25f));
    let _e15 = p_5;
    let _e17 = sdOctahedron(_e15, 0.5f);
    let _e19 = roundness_1;
    return (min(_e14, _e17) - (_e19 * 0.25f));
}

fn normal(p_6: vec3<f32>, roundness_2: f32) -> vec3<f32> {
    var p_7: vec3<f32>;
    var roundness_3: f32;
    var d: f32 = 0.0001f;
    var s_2: f32;
            ...
            if (_e223 != 1f) {
                {
                    ...
                    let _e235 = nIn;
                    let _e236 = camDir;
                    k_1 = (1f - ((_e228 * _e229) * (1f - (dot(_e232, _e233) * dot(_e235, _e236)))));
                    let _e243 = k_1;
                    if (_e243 < 0f) {
                        refractDir = vec3(0f);
                    } else {
