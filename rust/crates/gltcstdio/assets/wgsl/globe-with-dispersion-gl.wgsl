            ...
            if (_e123 == 0f) {
                {
                    ...
                    let _e135 = s;
                    let _e137 = d;
                    dilation = (1f + ((_e134 * _e135) / _e137));
                    let _e141 = modelTransform_1;
                    let _e142 = dilation;
                    let _e143 = u;
                    let _e144 = (_e142 * _e143);
                    coord = (_e141 * vec3<f32>(_e144.x, _e144.y, 1f)).xy;
                    let _e152 = coord;
            ...
            } else {
                {
                    loop {
                        ...
                        {
                            let _e194 = d;
                            let _e196 = intensity_1;
                            let _e198 = w_2;
                            let _e199 = dispersion_1;
                            let _e204 = hh;
                            s_1 = ((-(_e194) * (_e196 * (1f + (_e198 * _e199)))) / _e204);
                            let _e208 = h;
                            let _e209 = s_1;
                            let _e211 = d;
                            dilation_1 = (1f + ((_e208 * _e209) / _e211));
                            let _e215 = modelTransform_1;
                            let _e216 = dilation_1;
                            let _e217 = u;
                            let _e218 = (_e216 * _e217);
                            coord_1 = (_e215 * vec3<f32>(_e218.x, _e218.y, 1f)).xy;
                            let _e226 = w_2;
                            let _e227 = gwdGetRGBWeights(_e226);
                            weight = _e227;
                            let _e229 = totalColor;
                            let _e230 = weight;
                            let _e231 = coord_1;
                            let _e235 = global.U[0];
                            let _e238 = coord_1;
                            let _e247 = _mirror_wrap(((vec2<f32>((_e231.x / _e235.x), _e238.y) / vec2(2f)) + vec2(0.5f)));
                            let _e248 = textureSample(t_source, samp, _e247);
                            totalColor = (_e229 + (_e230 * _e248));
                            let _e251 = totalWeight;
                            let _e252 = weight;
                            totalWeight = (_e251 + _e252);
                        }
                        continuing {
                            let _e191 = w_2;
                            let _e192 = wStep;
