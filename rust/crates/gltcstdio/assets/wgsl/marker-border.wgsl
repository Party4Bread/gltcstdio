...
fn markerBorder(pos: vec2<f32>, outPos: vec2<f32>, border_2: f32, sourceDim: vec2<f32>, outDim: vec2<f32>, borderColor: vec4<f32>, variability_2: f32, randomSeed: f32, modelTransform: mat3x3<f32>, borderTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    let _e81 = borderTransform_1;
    let _e83 = pos_1;
    u_4 = (_naga_inverse_3x3_f32(_e81) * vec3<f32>(_e83.x, _e83.y, 1f)).xy;
    let _e91 = angleVariability_2;
    if (_e91 != 0f) {
        {
            let _e94 = angleVariability_2;
            let _e95 = variability_3;
            let _e99 = u_4;
            let _e102 = randomSeed_1;
            let _e103 = interpolatedRand2Seeded((_e99 * 0.01f), _e102);
            angle_1 = (((_e94 * _e95) * 3.1415927f) * (_e103.y - 0.5f));
            let _e109 = u_4;
            let _e111 = angle_1;
            let _e114 = u_4;
            let _e116 = angle_1;
            ...
            let _e125 = u_4;
            let _e127 = angle_1;
            u_4 = vec2<f32>(((_e109.x * cos(_e111)) - (_e114.y * sin(_e116))), ((_e120.y * cos(_e122)) + (_e125.x * sin(_e127))));
        }
    }
    let _e132 = u_4;
    u_4 = (_e132 * vec2<f32>(1f, 0.01f));
    let _e138 = u_4;
    let _e140 = B;
    let _e143 = variability_3;
    let _e146 = angleVariability_2;
    let _e147 = variability_3;
    let _e148 = randomSeed_1;
    let _e149 = circles(_e138, 100f, pow(_e140, 0.9f), (_e143 * 0.5f), _e146, _e147, _e148);
    k_8 = (1f - _e149);
    let _e152 = k_8;
    if (_e152 == 0f) {
        let _e155 = borderColor_1;
        return _e155;
    }
    ...
    let _e174 = textureSample(t_source, samp, _e173);
    let _e175 = k_8;
    return mix(_e156, _e174, vec4(_e175));
}
