    ...
    if (_e44.borderDist < (_e46 * 0.5f)) {
        {
            ...
            let _e67 = textureSample(t_source, samp, _e66);
            col = _e67;
            let _e69 = col;
            let _e70 = color_1;
    ...
    } else {
        {
            ...
            let _e91 = global.U[0];
            let _e94 = v;
            let _e95 = pixelation_1;
            let _e96 = l;
            let _e99 = cairo;
            let _e112 = _mirror_wrap(((vec2<f32>(((_e78 + ((_e79 * _e80) * vec2<f32>(0f, _e83.borderDist))).x / _e91.x), (_e94 + ((_e95 * _e96) * vec2<f32>(0f, _e99.borderDist))).y) / vec2(2f)) + vec2(0.5f)));
