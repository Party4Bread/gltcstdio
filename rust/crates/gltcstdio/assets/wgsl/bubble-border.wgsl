...
fn circles(coord_2: vec2<f32>, k_4: f32, baseRadius: f32, varRadius: f32, baseThickness: f32, varThickness: f32, seed_2: f32) -> f32 {
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    ...
                    let _e76 = varThickness_1;
                    let _e77 = delta;
                    let _e82 = baseThickness_1;
                    thickness = (((_e76 * _e77.y) + 1f) * _e82);
                    let _e85 = center;
                    let _e89 = delta;
                    let _e90 = k_5;
                    center = (_e85 + (vec2<f32>(0.5f, 0.5f) + ((_e89 * _e90) * 0.02f)));
                    let _e96 = coord_3;
                    let _e97 = center;
                    v_2 = (_e96 - _e97);
                    let _e100 = v_2;
...
fn interpolatedRand2Seeded(v_3: vec2<f32>, seed_4: f32) -> vec2<f32> {
    var v_4: vec2<f32>;
    var seed_5: f32;
    var sfractY: f32;
...
fn bubbleBorder(pos: vec2<f32>, outPos: vec2<f32>, border_2: f32, sourceDim: vec2<f32>, outDim: vec2<f32>, borderColor: vec4<f32>, variability: f32, randomSeed: f32, modelTransform: mat3x3<f32>, borderTransform: mat3x3<f32>) -> vec4<f32> {
    var pos_1: vec2<f32>;
    ...
    let _e99 = circles((_naga_inverse_3x3_f32(_e82) * vec3<f32>(_e84.x, _e84.y, 1f)).xy, 100f, _e92, 2f, (0.5f * _e95), 1f, _e98);
    k_6 = (1f - _e99);
    let _e102 = k_6;
    if (_e102 == 0f) {
        let _e105 = borderColor_1;
        return _e105;
    }
    let _e106 = borderColor_1;
    let _e107 = v_5;
    ...
    let _e125 = k_6;
    return mix(_e106, _e124, vec4(_e125));
}
