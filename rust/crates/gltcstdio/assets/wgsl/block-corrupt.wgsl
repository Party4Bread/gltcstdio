...
fn blockBW(pos_2: vec2<f32>, outPos: vec2<f32>, mode_2: i32, count: i32, randomSeed: f32, sourceDim: vec2<f32>, objectTransform: mat3x3<f32>, modelTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    ratio = (_e42.x / _e44.y);
    let _e49 = ratio;
    dim_2 = vec2<f32>((2f * _e49), 2f);
    let _e54 = dim_2;
    blockSize_2 = (_e54 / vec2<f32>(160f, 80f));
    let _e60 = dim_2;
    let _e62 = blockSize_2;
    columns_1 = (_e60.x / _e62.x);
    let _e66 = dim_2;
    let _e68 = blockSize_2;
    lines_1 = (_e66.y / _e68.y);
    let _e72 = columns_1;
    let _e73 = lines_1;
    blocks = (_e72 * _e73);
    let _e76 = modelTransform_1;
    let _e78 = pos_3;
    let _e79 = tf(_naga_inverse_3x3_f32(_e76), _e78);
    uv = _e79;
    let _e81 = uv;
    let _e83 = uv;
    let _e86 = (_e83.y + 3f);
    let _e95 = blockSize_2;
    let _e96 = dim_2;
    let _e97 = getIndex(vec2<f32>(_e81.x, ((_e86 - (floor((_e86 / 6f)) * 6f)) - 3f)), _e95, _e96);
    index = _e97;
    let _e99 = randomSeed_1;
    let _e100 = uv;
    randomSeed_1 = (_e99 + floor(((_e100.y + 3f) / 6f)));
    let _e112 = objectTransform_1[2][0];
    let _e115 = columns_1;
    let _e121 = objectTransform_1[2][1];
    let _e124 = lines_1;
    let _e126 = columns_1;
    let _e130 = blocks;
    offset = ((((_e112 * 0.5f) * _e115) + (((_e121 * 0.5f) * _e124) * _e126)) + (0.5f * _e130));
    let _e136 = objectTransform_1[0];
    scale = length(_e136.xy);
    loop {
        let _e142 = i;
        let _e143 = count_1;
        if !((_e142 < _e143)) {
        ...
        }
        {
            ...
            let _e163 = sineSurfaceRand2Seeded(vec2<f32>((10f - f32(_e150)), (15f + (5f * f32(_e155)))), (_e160 + 4.46f));
            rnd = _e163;
            let _e165 = offset;
            let _e166 = rnd;
            let _e168 = blocks;
            center = (_e165 + (_e166.x * _e168));
            let _e172 = rnd;
            let _e176 = i;
            if (_e172.x < (-0.5f + (f32(_e176) * 0.1f))) {
                local_7 = 0.5f;
            } else {
                let _e183 = rnd;
                let _e186 = blocks;
                let _e188 = scale;
                local_7 = ((abs(_e183.y) * _e186) * _e188);
            }
            let _e191 = local_7;
            bSize = _e191;
            let _e193 = center;
            ...
            let _e204 = index;
            let _e205 = ind2_;
            inside = ((_e201 >= _e202) && (_e204 <= _e205));
            let _e209 = inside;
            if _e209 {
                {
                    let _e210 = mode_3;
                    if (_e210 == 0i) {
                        {
                            let _e213 = rnd;
                            let _e216 = (_e213.x * 15f);
                            subMode = floor((_e216 - (floor((_e216 / 9f)) * 9f)));
                            g_1 = 0f;
                            let _e226 = subMode;
                            if (_e226 == 0f) {
                                {
                                    let _e229 = uv;
                                    let _e233 = randomSeed_1;
                                    let _e234 = rand2relSeeded(floor((_e229 * 320f)), _e233);
                                    if (fract(_e234.x) > 0.5f) {
                                        local_8 = 1f;
                                    } else {
                                        local_8 = 0f;
                                    }
                                ...
                                if (_e243 == 1f) {
                                    {
                                        let _e246 = uv;
                                        let _e250 = randomSeed_1;
                                        let _e251 = rand2relSeeded(floor((_e246 * 160f)), _e250);
                                        if (fract(_e251.x) > 0.5f) {
                                            local_9 = 1f;
                                        } else {
                                            local_9 = 0f;
                                        }
                                            ...
                                            if (_e288 == 6f) {
                                                {
                                                    let _e291 = uv;
                                                    let _e296 = inCol;
                                                    if (fract((_e291.x * 80f)) > (length(_e296.xyz) / 1.7f)) {
                                                        local_12 = 1f;
                                                    } else {
                                                        local_12 = 0f;
                                                    }
                                                ...
                                                if (_e306 == 7f) {
                                                    {
                                                        let _e309 = uv;
                                                        let _e314 = inCol;
                                                        if (fract((_e309.x * 10f)) < (length(_e314.xyz) / 1.7f)) {
                                                            local_13 = 1f;
                                                        } else {
                                                            local_13 = 0f;
                                                        }
                                                    ...
                                                    if (_e324 == 4f) {
                                                        {
                                                            ...
                                                            let _e337 = local_14;
                                                            let _e338 = uv;
                                                            if (fract((_e338.y * 40f)) > 0.5f) {
                                                                local_15 = 1f;
                                                            } else {
                                                                local_15 = 0f;
                                                            }
                                                            let _e348 = local_15;
                                                            let _e349 = (_e337 + _e348);
                                                            g_1 = (_e349 - (floor((_e349 / 2f)) * 2f));
                                                        }
                                                    } else {
                                                        let _e355 = subMode;
                                                        if (_e355 == 5f) {
                                                            {
                                                                let _e358 = uv;
                                                                let _e362 = randomSeed_1;
                                                                let _e363 = rand2relSeeded(floor((_e358 * 160f)), _e362);
                                                                let _e366 = inCol;
                                                                if (fract(_e363.x) < (length(_e366.xyz) / 1.7f)) {
                                                                    local_16 = 1f;
                                                                } else {
                                                                    local_16 = 0f;
                                                                }
                                                        ...
                                                        } else {
                                                            {
                                                                ...
                                                                let _e386 = local_17;
                                                                let _e387 = uv;
                                                                if (fract((_e387.y * 20f)) > 0.5f) {
                                                                    local_18 = 1f;
                                                                } else {
                                                                    local_18 = 0f;
                                                                }
                                                                let _e397 = local_18;
                                                                let _e398 = (_e386 + _e397);
                                                                g_1 = (_e398 - (floor((_e398 / 2f)) * 2f));
                                                            }
                                                        }
                                                    }
                                                }
                            ...
                            let _e405 = g_1;
                            let _e406 = g_1;
                            outCol = vec4<f32>(_e404, _e405, _e406, 1f);
                        }
                    } else {
                        let _e409 = mode_3;
                        if (_e409 == 1i) {
                            {
                                let _e412 = rnd;
                                mode_4 = ((_e412.x + 0.5f) * 4096f);
                                let _e419 = outCol;
                                let _e420 = mode_4;
                                let _e421 = swapRGBHSL(_e419, _e420);
                                outCol = _e421;
                            }
                        } else {
                            let _e422 = mode_3;
                            if (_e422 == 2i) {
                                {
                                    let _e425 = rnd;
                                    let _e428 = (_e425.x * 100f);
                                    channel_4 = i32((_e428 - (floor((_e428 / 3f)) * 3f)));
                                    let _e436 = rnd;
                                    delta = ((fract((_e436 * 10f)) * 2f) - vec2<f32>(1f, 1f));
                                    let _e447 = channel_4;
                                    let _e449 = channel_4;
                                    let _e450 = pos_3;
                                    let _e451 = delta;
                                    ...
                                    let _e459 = pos_3;
                                    let _e460 = delta;
                                    let _e470 = textureSample(t_source, samp, ((vec2<f32>(((_e450 + _e451).x / _e456.x), (_e459 + _e460).y) / vec2(2f)) + vec2(0.5f)));
                                    outCol[_e447] = _e470[_e449];
                                }
                            } else {
                                let _e472 = mode_3;
                                if (_e472 == 3i) {
                                    {
                                        let _e475 = rnd;
                                        delta_1 = ((fract((_e475 * 10f)) * 2f) - vec2<f32>(1f, 1f));
                                        let _e486 = pos_3;
                                        let _e487 = delta_1;
                                        let _e492 = global.U[0];
                                        let _e495 = pos_3;
                                        let _e496 = delta_1;
                                        let _e506 = textureSample(t_source, samp, ((vec2<f32>(((_e486 + _e487).x / _e492.x), (_e495 + _e496).y) / vec2(2f)) + vec2(0.5f)));
                                        outCol = _e506;
                                    }
                                }
                            }
