...
fn sdTorus(p: vec3<f32>, R: f32, rb: f32) -> f32 {
    var p_1: vec3<f32>;
    var R_1: f32;
    var rb_1: f32;
    var q: vec2<f32>;
    ...
    let _e16 = R_1;
    let _e18 = p_1;
    q = vec2<f32>((length(_e13.xy) - _e16), _e18.z);
    let _e22 = q;
    let _e24 = rb_1;
    return (length(_e22) - _e24);
}

fn sdf(p_2: vec3<f32>, radius: f32) -> f32 {
    var p_3: vec3<f32>;
    var radius_1: f32;
    ...
    let _e11 = p_3;
    let _e13 = radius_1;
    let _e16 = sdTorus(_e11, 0.4f, (_e13 * 0.8f));
    return _e16;
}

fn normal(p_4: vec3<f32>, radius_2: f32) -> vec3<f32> {
    var p_5: vec3<f32>;
    var radius_3: f32;
    var d: f32 = 0.0001f;
    var s: f32;
