...
#define u_multiplier (U[8].x)
#define u_colorOutline (U[9])
#define u_outlineThickness (U[10].x)
...
#define u_shadowTransform (mat3(U[26].xyz, U[27].xyz, U[28].xyz))
...
vec4 basicInterpolatedShapes(vec2 uv, vec2 outPos, int insideImage_specified, 
    ...
    float d = 0.0;
    d = sdStar(vec2(u.x, -u.y), 24, 0.75, 2.0 + 0.93*(24.0-2.0));
