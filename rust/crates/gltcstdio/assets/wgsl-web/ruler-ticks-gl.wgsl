...
fn rulerTicksGL(pos: vec2<f32>, outPos: vec2<f32>, glow_2: f32, color1_: vec4<f32>, modelTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    if (abs(_e36) > 50f) {
        ...
        let _e44 = global.U[0];
        let _e47 = pos_1;
        let _e57 = textureSampleLevel(t_source, samp, ((vec2<f32>((_e40.x / _e44.x), _e47.y) / vec2(2f)) + vec2(0.5f)), 0f);
        return _e57;
    }
    let _e58 = n;
    let _e61 = (abs(_e58) + 0.5f);
    if ((_e61 - (floor((_e61 / 5f)) * 5f)) < 1f) {
        local_3 = 1.5f;
    } else {
        local_3 = 1f;
    }
    ...
    hTick = (0.05f * _e75);
    let _e79 = bigTick;
    strokeHalf = (0.0015f * _e79);
    let _e82 = p;
    let _e84 = p;
    let _e86 = n;
    let _e87 = step;
    q = vec2<f32>(_e82.x, (_e84.y - (_e86 * _e87)));
    let _e92 = q;
    let _e93 = hTick;
    let _e94 = strokeHalf;
    let _e96 = sdRectangle(_e92, vec2<f32>(_e93, _e94));
    d_2 = _e96;
    let _e98 = d_2;
    let _e99 = glow_3;
    let _e100 = rt_response(_e98, _e99);
    k = _e100;
    let _e102 = pos_1;
    ...
    let _e121 = color1_1;
    let _e124 = k;
    let _e126 = (_e121.xyz * max(1f, _e124));
    let _e127 = color1_1;
    let _e133 = spilloverChannels(vec4<f32>(_e126.x, _e126.y, _e126.z, _e127.w));
    glowCol = _e133;
    let _e135 = bkgCol;
    let _e136 = glowCol;
    let _e137 = _e136.xyz;
    let _e138 = glowCol;
    let _e141 = k;
    let _e148 = mergeColor(_e135, vec4<f32>(_e137.x, _e137.y, _e137.z, (_e138.w * min(1f, _e141))));
    outCol = _e148;
    let _e150 = outCol;
    return _e150;
}
