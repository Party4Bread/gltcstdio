...
fn basicInterpolatedShapes(uv: vec2<f32>, outPos: vec2<f32>, insideImage_specified: i32, shadows: f32, roundness: f32, multiplier: f32, colorOutline: vec4<f32>, outlineThickness: f32, brightness_2: f32, contrast_2: f32, saturation_2: f32, hue_2: f32, colorIn: vec4<f32>, colorOut: vec4<f32>, colorShadow: vec4<f32>, colorGlow: vec4<f32>, insideLock: i32, modelTransform: mat3x3<f32>, insideTransform: mat3x3<f32>, shadowTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    u_4 = _e50;
    let _e54 = u_4;
    let _e56 = sdDisk(_e54, 0.5f);
    d = _e56;
    let _e57 = d;
    let _e58 = multiplier_1;
    let _e60 = roundness_1;
    d = ((_e57 * _e58) - _e60);
    let _e67 = uv_1;
    v = _e67;
    let _e69 = d;
    ...
    if _e73 {
        {
            ...
            if (_e74 < 0f) {
                {
                    ...
                    saveD = _e81;
                    let _e83 = d;
                    let _e84 = multiplier_1;
                    let _e86 = roundness_1;
                    d = ((_e83 * _e84) - _e86);
                    let _e88 = u_4;
                    let _e90 = sdDisk(_e88, 0.5f);
                    d = _e90;
                    let _e92 = shadows_1;
                    let _e94 = d;
                    shadow = (0.7f * smoothstep(_e92, 0f, _e94));
                    let _e97 = saveD;
                    d = _e97;
                }
            }
            let _e98 = colorIn_1;
            tint_4 = _e98;
            let _e99 = insideLock_1;
            if (_e99 == 0i) {
                let _e102 = insideTransform_1;
                local_8 = _e102;
            } else {
            ...
            if (_e113 > 0f) {
                {
                    ...
                    saveD_1 = _e120;
                    let _e122 = d;
                    let _e123 = multiplier_1;
                    let _e125 = roundness_1;
                    d = ((_e122 * _e123) - _e125);
                    let _e127 = u_4;
                    let _e129 = sdDisk(_e127, 0.5f);
                    d = _e129;
                    let _e131 = shadows_1;
                    let _e133 = d;
                    shadow = (0.7f * smoothstep(_e131, 0f, _e133));
                    let _e136 = saveD_1;
                    d = _e136;
                }
            }
            let _e137 = colorOut_1;
            tint_4 = _e137;
        }
    }
    let _e138 = insideImage_specified_1;
    let _e141 = inside;
    if ((_e138 == 1i) && _e141) {
        let _e143 = v;
        ...
        let _e161 = textureSampleLevel(t_insideImage, samp, _e159, 0f);
        local_9 = _e161;
    } else {
        let _e162 = v;
        let _e166 = global.U[0];
        let _e169 = v;
        let _e178 = _mirror_wrap(((vec2<f32>((_e162.x / _e166.x), _e169.y) / vec2(2f)) + vec2(0.5f)));
        let _e180 = textureSampleLevel(t_source, samp, _e178, 0f);
        local_9 = _e180;
    }
    let _e182 = local_9;
    sColor = _e182;
    ...
    if _e186 {
        let _e187 = color;
        let _e188 = brightness_3;
        let _e189 = contrast_3;
        let _e192 = saturation_3;
        let _e193 = hue_3;
        let _e196 = adjustColorHSLuv(_e187, _e188, _e189, 0f, 0f, _e192, _e193, vec4(0f));
        color = _e196;
    }
    let _e197 = colorGlow_1;
    if (_e197.w != 0f) {
        let _e201 = colorGlow_1;
        let _e205 = d;
        let _e208 = ((_e201.xyz * 0.01f) / vec3(abs(_e205)));
        let _e210 = colorGlow_1;
        let _e214 = d;
        local_10 = vec4<f32>(_e208.x, _e208.y, _e208.z, min(1f, ((_e210.w * 0.01f) / abs(_e214))));
    } else {
        local_10 = vec4(0f);
    }
    let _e225 = local_10;
    ...
    let _e227 = color;
    let _e228 = tint_4;
    let _e229 = mergeColor(_e227, _e228);
    let _e230 = colorShadow_1;
    let _e231 = _e230.xyz;
    let _e232 = colorShadow_1;
    let _e234 = shadow;
    let _e240 = mergeColor(_e229, vec4<f32>(_e231.x, _e231.y, _e231.z, (_e232.w * _e234)));
    let _e241 = glow_2;
    let _e242 = mergeGlow(_e240, _e241);
    color = _e242;
    let _e243 = d;
    let _e245 = outlineThickness_1;
    if (abs(_e243) < (_e245 * 0.5f)) {
        {
            let _e249 = color;
            let _e250 = colorOutline_1;
            let _e251 = mergeColor(_e249, _e250);
            color = _e251;
            shadow = 0f;
        }
    }
