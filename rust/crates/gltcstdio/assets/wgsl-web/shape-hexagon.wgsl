...
fn sdNgon(p_4: vec2<f32>, r_1: f32, n: i32) -> f32 {
    var p_5: vec2<f32>;
    var r_2: f32;
    var n_1: i32;
    var an: f32;
...
fn basicInterpolatedShapes(uv: vec2<f32>, outPos: vec2<f32>, insideImage_specified: i32, shadows: f32, roundness: f32, multiplier: f32, colorOutline: vec4<f32>, outlineThickness: f32, brightness_2: f32, contrast_2: f32, saturation_2: f32, hue_2: f32, colorIn: vec4<f32>, colorOut: vec4<f32>, colorShadow: vec4<f32>, colorGlow: vec4<f32>, insideLock: i32, modelTransform: mat3x3<f32>, insideTransform: mat3x3<f32>, shadowTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    u_2 = _e50;
    let _e54 = u_2;
    let _e57 = sdNgon(_e54, 0.5f, 6i);
    d = _e57;
    let _e58 = d;
    let _e59 = multiplier_1;
    let _e61 = roundness_1;
    d = ((_e58 * _e59) - _e61);
    let _e68 = uv_1;
    v = _e68;
    let _e70 = d;
    ...
    if _e74 {
        {
            ...
            if (_e75 < 0f) {
                {
                    let _e78 = shadowTransform_1;
                    let _e80 = u_2;
                    let _e81 = tf(_naga_inverse_3x3_f32(_e78), _e80);
                    u_2 = _e81;
                    let _e82 = d;
                    saveD = _e82;
                    let _e84 = d;
                    let _e85 = multiplier_1;
                    let _e87 = roundness_1;
                    d = ((_e84 * _e85) - _e87);
                    let _e89 = u_2;
                    let _e92 = sdNgon(_e89, 0.5f, 6i);
                    d = _e92;
                    let _e94 = shadows_1;
                    let _e96 = d;
                    shadow = (0.7f * smoothstep(_e94, 0f, _e96));
                    let _e99 = saveD;
                    d = _e99;
                }
            }
            let _e100 = colorIn_1;
            tint_4 = _e100;
            let _e101 = insideLock_1;
            if (_e101 == 0i) {
                let _e104 = insideTransform_1;
                local_8 = _e104;
            } else {
                let _e105 = modelTransform_1;
                let _e106 = insideTransform_1;
                local_8 = (_e105 * _e106);
            }
            let _e109 = local_8;
            iTransform = _e109;
            let _e111 = iTransform;
            let _e113 = uv_1;
            let _e114 = tf(_naga_inverse_3x3_f32(_e111), _e113);
            v = _e114;
        }
    } else {
        {
            ...
            if (_e115 > 0f) {
                {
                    let _e118 = shadowTransform_1;
                    let _e120 = u_2;
                    let _e121 = tf(_naga_inverse_3x3_f32(_e118), _e120);
                    u_2 = _e121;
                    let _e122 = d;
                    saveD_1 = _e122;
                    let _e124 = d;
                    let _e125 = multiplier_1;
                    let _e127 = roundness_1;
                    d = ((_e124 * _e125) - _e127);
                    let _e129 = u_2;
                    let _e132 = sdNgon(_e129, 0.5f, 6i);
                    d = _e132;
                    let _e134 = shadows_1;
                    let _e136 = d;
                    shadow = (0.7f * smoothstep(_e134, 0f, _e136));
                    let _e139 = saveD_1;
                    d = _e139;
                }
            }
            let _e140 = colorOut_1;
            tint_4 = _e140;
        }
    }
    let _e141 = insideImage_specified_1;
    let _e144 = inside;
    if ((_e141 == 1i) && _e144) {
        let _e146 = v;
        let _e150 = global.U[0];
        let _e153 = v;
        let _e162 = _mirror_wrap(((vec2<f32>((_e146.x / _e150.x), _e153.y) / vec2(2f)) + vec2(0.5f)));
        let _e164 = textureSampleLevel(t_insideImage, samp, _e162, 0f);
        local_9 = _e164;
    } else {
        let _e165 = v;
    ...
    if _e189 {
        let _e190 = color;
        let _e191 = brightness_3;
        let _e192 = contrast_3;
        let _e195 = saturation_3;
        let _e196 = hue_3;
        let _e199 = adjustColorHSLuv(_e190, _e191, _e192, 0f, 0f, _e195, _e196, vec4(0f));
        color = _e199;
    }
    let _e200 = colorGlow_1;
    if (_e200.w != 0f) {
        let _e204 = colorGlow_1;
        let _e208 = d;
        let _e211 = ((_e204.xyz * 0.01f) / vec3(abs(_e208)));
        let _e213 = colorGlow_1;
        let _e217 = d;
        local_10 = vec4<f32>(_e211.x, _e211.y, _e211.z, min(1f, ((_e213.w * 0.01f) / abs(_e217))));
    } else {
        local_10 = vec4(0f);
    }
    let _e228 = local_10;
    ...
    let _e230 = color;
    let _e231 = tint_4;
    let _e232 = mergeColor(_e230, _e231);
    let _e233 = colorShadow_1;
    let _e234 = _e233.xyz;
    let _e235 = colorShadow_1;
    let _e237 = shadow;
    let _e243 = mergeColor(_e232, vec4<f32>(_e234.x, _e234.y, _e234.z, (_e235.w * _e237)));
    let _e244 = glow_2;
    let _e245 = mergeGlow(_e243, _e244);
    color = _e245;
    let _e246 = d;
    let _e248 = outlineThickness_1;
    if (abs(_e246) < (_e248 * 0.5f)) {
        {
            let _e252 = color;
            let _e253 = colorOutline_1;
            let _e254 = mergeColor(_e252, _e253);
            color = _e254;
            shadow = 0f;
        }
    }
