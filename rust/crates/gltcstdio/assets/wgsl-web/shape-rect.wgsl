...
fn basicInterpolatedShapes(uv: vec2<f32>, outPos: vec2<f32>, insideImage_specified: i32, shapeAspectRatio: f32, shadows: f32, roundness: f32, multiplier: f32, colorOutline: vec4<f32>, outlineThickness: f32, brightness_2: f32, contrast_2: f32, saturation_2: f32, hue_2: f32, colorIn: vec4<f32>, colorOut: vec4<f32>, colorShadow: vec4<f32>, colorGlow: vec4<f32>, insideLock: i32, modelTransform: mat3x3<f32>, insideTransform: mat3x3<f32>, shadowTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    u_4 = _e52;
    let _e56 = u_4;
    let _e58 = shapeAspectRatio_1;
    let _e59 = dimFromShapeAspectRatio(0.5f, _e58);
    let _e60 = sdRectangle(_e56, _e59);
    d = _e60;
    let _e61 = d;
    let _e62 = multiplier_1;
    let _e64 = roundness_1;
    d = ((_e61 * _e62) - _e64);
    let _e71 = uv_1;
    v = _e71;
    let _e73 = d;
    ...
    if _e77 {
        {
            ...
            if (_e78 < 0f) {
                {
                    let _e81 = shadowTransform_1;
                    let _e83 = u_4;
                    let _e84 = tf(_naga_inverse_3x3_f32(_e81), _e83);
                    u_4 = _e84;
                    let _e85 = d;
                    saveD = _e85;
                    let _e87 = d;
                    let _e88 = multiplier_1;
                    let _e90 = roundness_1;
                    d = ((_e87 * _e88) - _e90);
                    let _e92 = u_4;
                    let _e94 = shapeAspectRatio_1;
                    let _e95 = dimFromShapeAspectRatio(0.5f, _e94);
                    let _e96 = sdRectangle(_e92, _e95);
                    d = _e96;
                    let _e98 = shadows_1;
                    let _e100 = d;
                    shadow = (0.7f * smoothstep(_e98, 0f, _e100));
                    let _e103 = saveD;
                    d = _e103;
                }
            }
            let _e104 = colorIn_1;
            tint_4 = _e104;
            let _e105 = insideLock_1;
            if (_e105 == 0i) {
                let _e108 = insideTransform_1;
                local_10 = _e108;
            } else {
                let _e109 = modelTransform_1;
                let _e110 = insideTransform_1;
                local_10 = (_e109 * _e110);
            }
            let _e113 = local_10;
            iTransform = _e113;
            let _e115 = iTransform;
            let _e117 = uv_1;
            let _e118 = tf(_naga_inverse_3x3_f32(_e115), _e117);
            v = _e118;
        }
    } else {
        {
            ...
            if (_e119 > 0f) {
                {
                    let _e122 = shadowTransform_1;
                    let _e124 = u_4;
                    let _e125 = tf(_naga_inverse_3x3_f32(_e122), _e124);
                    u_4 = _e125;
                    let _e126 = d;
                    saveD_1 = _e126;
                    let _e128 = d;
                    let _e129 = multiplier_1;
                    let _e131 = roundness_1;
                    d = ((_e128 * _e129) - _e131);
                    let _e133 = u_4;
                    let _e135 = shapeAspectRatio_1;
                    let _e136 = dimFromShapeAspectRatio(0.5f, _e135);
                    let _e137 = sdRectangle(_e133, _e136);
                    d = _e137;
                    let _e139 = shadows_1;
                    let _e141 = d;
                    shadow = (0.7f * smoothstep(_e139, 0f, _e141));
                    let _e144 = saveD_1;
                    d = _e144;
                }
            }
            let _e145 = colorOut_1;
            tint_4 = _e145;
        }
    }
    let _e146 = insideImage_specified_1;
    let _e149 = inside;
    if ((_e146 == 1i) && _e149) {
        let _e151 = v;
        ...
        let _e169 = textureSampleLevel(t_insideImage, samp, _e167, 0f);
        local_11 = _e169;
    } else {
        let _e170 = v;
        let _e174 = global.U[0];
        let _e177 = v;
        let _e186 = _mirror_wrap(((vec2<f32>((_e170.x / _e174.x), _e177.y) / vec2(2f)) + vec2(0.5f)));
        let _e188 = textureSampleLevel(t_source, samp, _e186, 0f);
        local_11 = _e188;
    }
    let _e190 = local_11;
    sColor = _e190;
    ...
    if _e194 {
        let _e195 = color;
        let _e196 = brightness_3;
        let _e197 = contrast_3;
        let _e200 = saturation_3;
        let _e201 = hue_3;
        let _e204 = adjustColorHSLuv(_e195, _e196, _e197, 0f, 0f, _e200, _e201, vec4(0f));
        color = _e204;
    }
    let _e205 = colorGlow_1;
    if (_e205.w != 0f) {
        let _e209 = colorGlow_1;
        let _e213 = d;
        let _e216 = ((_e209.xyz * 0.01f) / vec3(abs(_e213)));
        let _e218 = colorGlow_1;
        let _e222 = d;
        local_12 = vec4<f32>(_e216.x, _e216.y, _e216.z, min(1f, ((_e218.w * 0.01f) / abs(_e222))));
    } else {
        local_12 = vec4(0f);
    }
    let _e233 = local_12;
    ...
    let _e238 = colorShadow_1;
    let _e239 = _e238.xyz;
    let _e240 = colorShadow_1;
    let _e242 = shadow;
    let _e248 = mergeColor(_e237, vec4<f32>(_e239.x, _e239.y, _e239.z, (_e240.w * _e242)));
    let _e249 = glow_2;
    let _e250 = mergeGlow(_e248, _e249);
    color = _e250;
    let _e251 = d;
    let _e253 = outlineThickness_1;
    if (abs(_e251) < (_e253 * 0.5f)) {
        {
            let _e257 = color;
            let _e258 = colorOutline_1;
            let _e259 = mergeColor(_e257, _e258);
            color = _e259;
            shadow = 0f;
        }
    }
