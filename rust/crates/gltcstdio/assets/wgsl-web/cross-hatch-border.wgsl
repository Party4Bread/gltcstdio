...
fn crossHatchBorder(pos: vec2<f32>, outPos: vec2<f32>, border_2: f32, sourceDim: vec2<f32>, outDim: vec2<f32>, borderColor: vec4<f32>, variability: f32, randomSeed: f32, modelTransform: mat3x3<f32>, borderTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    let _e84 = borderTransform_1;
    let _e86 = pos_1;
    u_6 = (_naga_inverse_3x3_f32(_e84) * vec3<f32>(_e86.x, _e86.y, 1f)).xy;
    let _e94 = B;
    let _e97 = B;
    let _e99 = u_6;
    let _e101 = freq_3;
    let _e103 = hatch(_e99, 0.2f, _e101, 2f);
    k_4 = smoothstep((_e94 - 0.01f), _e97, (1f - _e103));
    let _e107 = k_4;
    if (_e107 == 0f) {
    ...
    let _e130 = textureSampleLevel(t_source, samp, _e128, 0f);
    let _e131 = k_4;
    return mix(_e111, _e130, vec4(_e131));
}
