...
fn hyperbolicGroupLimit(uv: vec2<f32>, outPos: vec2<f32>, iterations_4: i32, color1_2: vec4<f32>, color2_2: vec4<f32>, color3_2: vec4<f32>, glow_2: f32, paramP: i32, paramQ: i32, paramR: i32, offset_2: f32, border: f32, borderColor: vec4<f32>, colorSpecular_2: vec4<f32>, modelControl_10: f32, mode: i32, modelTransform: mat3x3<f32>, texTransform: mat3x3<f32>, model3DTransform: mat4x4<f32>, lightSourceTransform: mat4x4<f32>) -> vec4<f32> {
    ...
    if (_e247 == 0f) {
        {
            ...
            let _e331 = textureSampleLevel(t_source, samp, ((vec2<f32>((_e311.x / _e315.x), _e321.y) / vec2(2f)) + vec2(0.5f)), 0f);
            let _e332 = basecol_2;
            ...
            let _e338 = lp_2;
            let _e339 = basecol_2;
            let _e340 = colorSpecular_3;
            let _e341 = modelControl_11;
            let _e342 = getColor(_e334, _e335, _e336, _e337, _e338, _e339, _e340, _e341);
            col_2 = _e342;
        }
    } else {
        let _e343 = id_1;
        if (_e343 == 1f) {
            {
                let _e351 = pos_2;
                let _e353 = planeToSphere(_e351.xz);
                q_3 = _e353;
                let _e355 = q_3;
                let _e356 = mouRot;
                q_3 = (_e355 * _e356);
                ...
                let _e362 = C_4;
                let _e363 = D_4;
                let _e365 = iterations_5;
                let _e369 = iterateSpherePoint((&q_3), (&count_5), _e360, _e361, _e362, _e363, (&orb_4), _e365);
                found_2 = _e369;
                let _e370 = q_3;
                let _e371 = A_4;
                let _e372 = B_4;
                let _e373 = C_4;
                let _e374 = D_4;
                let _e375 = distABCD(_e370, _e371, _e372, _e373, _e374);
                edist = _e375;
                let _e376 = found_2;
                let _e377 = count_5;
                let _e378 = orb_4;
                ...
                let _e380 = color2_3;
                let _e381 = color3_3;
                let _e382 = glowFactor;
                let _e383 = iterations_5;
                let _e384 = chooseColor(_e376, _e377, _e378, _e379, _e380, _e381, _e382, _e383);
                basecol_3 = _e384;
                let _e386 = q_3;
                texUV_1 = _e386.xy;
                let _e389 = offset_3;
                if (_e389 != 0f) {
                    ...
                    let _e393 = offset_3;
                    let _e394 = pos_2;
                    texUV_1 = (_e392 + (_e393 * _e394.xz));
                }
                let _e398 = texTransform_1;
                let _e400 = texUV_1;
                let _e401 = tf(_naga_inverse_3x3_f32(_e398), _e400);
                let _e405 = global.U[0];
                let _e408 = texTransform_1;
                let _e410 = texUV_1;
                let _e411 = tf(_naga_inverse_3x3_f32(_e408), _e410);
                let _e421 = textureSampleLevel(t_source, samp, ((vec2<f32>((_e401.x / _e405.x), _e411.y) / vec2(2f)) + vec2(0.5f)), 0f);
                let _e422 = basecol_3;
                let _e423 = mergeColor(_e421, _e422);
                basecol_3 = _e423;
                let _e424 = camera;
                let _e425 = rd_6;
                let _e426 = pos_2;
                ...
                let _e428 = lp_2;
                let _e429 = basecol_3;
                let _e430 = colorSpecular_3;
                let _e431 = modelControl_11;
                let _e432 = getColor(_e424, _e425, _e426, _e427, _e428, _e429, _e430, _e431);
                col_2 = _e432;
                let _e433 = col_2;
                let _e435 = col_2;
                let _e438 = (_e435.xyz * 0.9f);
                col_2.x = _e438.x;
                col_2.y = _e438.y;
                col_2.z = _e438.z;
            }
    ...
    if (_e450 != 0f) {
        ...
        let _e462 = border_1;
        let _e464 = edist;
        col_2 = mix(_e453, _e454, vec4(((1f - smoothstep(((0.05f * _e457) - 0.0025f), (0.1f * _e462), _e464)) * 0.85f)));
    }
    let _e471 = col_2;
    let _e473 = col_2;
    let _e480 = t_3;
    let _e482 = t_3;
    let _e487 = mix(_e473.xyz, vec3(0f), vec3((1f - exp(((-0.01f * _e480) * _e482)))));
    col_2.x = _e487.x;
    col_2.y = _e487.y;
    col_2.z = _e487.z;
    let _e494 = finalcol;
    let _e495 = col_2;
    finalcol = (_e494 + _e495);
    let _e497 = finalcol;
    let _e499 = finalcol;
    let _e502 = finalcol;
    let _e510 = mix(_e499.xyz, (vec3(1f) - exp(-(_e502.xyz))), vec3(0.35f));
    finalcol.x = _e510.x;
    finalcol.y = _e510.y;
    finalcol.z = _e510.z;
    let _e517 = finalcol;
    let _e522 = sqrt(max(_e517.xyz, vec3(0f)));
    let _e523 = finalcol;
    return vec4<f32>(_e522.x, _e522.y, _e522.z, _e523.w);
}
