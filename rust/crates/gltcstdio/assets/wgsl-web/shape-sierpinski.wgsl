...
fn sdEquiTriangle(u: vec2<f32>) -> f32 {
    var u_1: vec2<f32>;
    ...
    if ((_e22.x + (1.7320508f * _e25.y)) > 0f) {
        ...
        let _e40 = u_1;
        let _e43 = u_1;
        u_1 = (vec2<f32>((_e31.x - (1.7320508f * _e34.y)), ((-1.7320508f * _e40.x) - _e43.y)) / vec2(2f));
    }
    let _e51 = u_1;
    let _e53 = u_1;
    u_1.x = (_e51.x - clamp(_e53.x, -2f, 0f));
    let _e60 = u_1;
    let _e63 = u_1;
...
fn basicInterpolatedShapes(uv: vec2<f32>, outPos: vec2<f32>, insideImage_specified: i32, iterations: i32, shadows: f32, roundness: f32, multiplier: f32, colorOutline: vec4<f32>, outlineThickness: f32, brightness_2: f32, contrast_2: f32, saturation_2: f32, hue_2: f32, colorIn: vec4<f32>, colorOut: vec4<f32>, colorShadow: vec4<f32>, colorGlow: vec4<f32>, insideLock: i32, modelTransform: mat3x3<f32>, insideTransform: mat3x3<f32>, shadowTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    loop {
        ...
        }
        {
            let _e67 = uu;
            let _e69 = uu;
            ang = atan2(_e67.x, _e69.y);
            let _e73 = ang;
            if (_e73 > 1.0471976f) {
                let _e77 = rotation2_(2.0943952f);
                let _e78 = uu;
                uu = (_e77 * _e78);
            } else {
                let _e80 = ang;
                if (_e80 < -1.0471976f) {
                    let _e86 = rotation2_(-2.0943952f);
                    let _e87 = uu;
                    uu = (_e86 * _e87);
                }
            }
            ...
            uu = (_e89 * 3f);
            let _e93 = uu;
            uu.y = (_e93.y - 1.1547005f);
            let _e99 = uu;
            let _e100 = sdEquiTriangle(_e99);
            d = _e100;
            let _e101 = d;
            if (_e101 < 0f) {
                {
    ...
    let _e108 = d;
    let _e109 = multiplier_1;
    let _e111 = roundness_1;
    d = ((_e108 * _e109) - _e111);
    let _e118 = uv_1;
    v = _e118;
    let _e120 = d;
    ...
    if _e124 {
        {
            ...
            if (_e125 < 0f) {
                {
                    let _e128 = shadowTransform_1;
                    let _e130 = u_4;
                    let _e131 = tf(_naga_inverse_3x3_f32(_e128), _e130);
                    u_4 = _e131;
                    let _e132 = d;
                    saveD = _e132;
                    let _e134 = d;
                    let _e135 = multiplier_1;
                    let _e137 = roundness_1;
                    d = ((_e134 * _e135) - _e137);
                    let _e139 = u_4;
                    uu_1 = _e139;
                    loop {
                        let _e143 = i_1;
                        let _e144 = iterations_1;
                        if !((_e143 < _e144)) {
                            break;
                        }
                        {
                            let _e150 = uu_1;
                            let _e152 = uu_1;
                            ang_1 = atan2(_e150.x, _e152.y);
                            let _e156 = ang_1;
                            if (_e156 > 1.0471976f) {
                                let _e160 = rotation2_(2.0943952f);
                                let _e161 = uu_1;
                                uu_1 = (_e160 * _e161);
                            } else {
                                let _e163 = ang_1;
                                if (_e163 < -1.0471976f) {
                                    let _e169 = rotation2_(-2.0943952f);
                                    let _e170 = uu_1;
                                    uu_1 = (_e169 * _e170);
                                }
                            }
                            ...
                            uu_1 = (_e172 * 3f);
                            let _e176 = uu_1;
                            uu_1.y = (_e176.y - 1.1547005f);
                            let _e182 = uu_1;
                            let _e183 = sdEquiTriangle(_e182);
                            d = _e183;
                            let _e184 = d;
                            if (_e184 < 0f) {
                                {
                                    let _e187 = uu_1;
                                    uu_1 = (_e187 / vec2(1.5f));
                                }
                            } else {
                                break;
                            }
                    ...
                    let _e192 = shadows_1;
                    let _e194 = d;
                    shadow = (0.7f * smoothstep(_e192, 0f, _e194));
                    let _e197 = saveD;
                    d = _e197;
                }
            }
            let _e198 = colorIn_1;
            tint_4 = _e198;
            let _e199 = insideLock_1;
            if (_e199 == 0i) {
                let _e202 = insideTransform_1;
                local_8 = _e202;
            } else {
                let _e203 = modelTransform_1;
                let _e204 = insideTransform_1;
                local_8 = (_e203 * _e204);
            }
            let _e207 = local_8;
            iTransform = _e207;
            let _e209 = iTransform;
            let _e211 = uv_1;
            let _e212 = tf(_naga_inverse_3x3_f32(_e209), _e211);
            v = _e212;
        }
    } else {
        {
            ...
            if (_e213 > 0f) {
                {
                    let _e216 = shadowTransform_1;
                    let _e218 = u_4;
                    let _e219 = tf(_naga_inverse_3x3_f32(_e216), _e218);
                    u_4 = _e219;
                    let _e220 = d;
                    saveD_1 = _e220;
                    let _e222 = d;
                    let _e223 = multiplier_1;
                    let _e225 = roundness_1;
                    d = ((_e222 * _e223) - _e225);
                    let _e227 = u_4;
                    uu_2 = _e227;
                    loop {
                        ...
                        }
                        {
                            let _e238 = uu_2;
                            let _e240 = uu_2;
                            ang_2 = atan2(_e238.x, _e240.y);
                            let _e244 = ang_2;
                            if (_e244 > 1.0471976f) {
                                let _e248 = rotation2_(2.0943952f);
                                let _e249 = uu_2;
                                uu_2 = (_e248 * _e249);
                            } else {
                                let _e251 = ang_2;
                                if (_e251 < -1.0471976f) {
                                    let _e257 = rotation2_(-2.0943952f);
                                    let _e258 = uu_2;
                                    uu_2 = (_e257 * _e258);
                                }
                            }
                            ...
                            uu_2 = (_e260 * 3f);
                            let _e264 = uu_2;
                            uu_2.y = (_e264.y - 1.1547005f);
                            let _e270 = uu_2;
                            let _e271 = sdEquiTriangle(_e270);
                            d = _e271;
                            let _e272 = d;
                            if (_e272 < 0f) {
                                {
                                    let _e275 = uu_2;
                                    uu_2 = (_e275 / vec2(1.5f));
                                }
                            } else {
                                break;
                            }
                    ...
                    let _e280 = shadows_1;
                    let _e282 = d;
                    shadow = (0.7f * smoothstep(_e280, 0f, _e282));
                    let _e285 = saveD_1;
                    d = _e285;
                }
            }
            let _e286 = colorOut_1;
            tint_4 = _e286;
        }
    }
    let _e287 = insideImage_specified_1;
    let _e290 = inside;
    if ((_e287 == 1i) && _e290) {
        let _e292 = v;
        let _e296 = global.U[0];
        let _e299 = v;
        let _e308 = _mirror_wrap(((vec2<f32>((_e292.x / _e296.x), _e299.y) / vec2(2f)) + vec2(0.5f)));
        let _e310 = textureSampleLevel(t_insideImage, samp, _e308, 0f);
        local_9 = _e310;
    } else {
        let _e311 = v;
        let _e315 = global.U[0];
        let _e318 = v;
        let _e327 = _mirror_wrap(((vec2<f32>((_e311.x / _e315.x), _e318.y) / vec2(2f)) + vec2(0.5f)));
        let _e329 = textureSampleLevel(t_source, samp, _e327, 0f);
        local_9 = _e329;
    }
    let _e331 = local_9;
    sColor = _e331;
    ...
    if _e335 {
        let _e336 = color;
        let _e337 = brightness_3;
        let _e338 = contrast_3;
        let _e341 = saturation_3;
        let _e342 = hue_3;
        let _e345 = adjustColorHSLuv(_e336, _e337, _e338, 0f, 0f, _e341, _e342, vec4(0f));
        color = _e345;
    }
    let _e346 = colorGlow_1;
    if (_e346.w != 0f) {
        let _e350 = colorGlow_1;
        let _e354 = d;
        let _e357 = ((_e350.xyz * 0.01f) / vec3(abs(_e354)));
        let _e359 = colorGlow_1;
        let _e363 = d;
        local_10 = vec4<f32>(_e357.x, _e357.y, _e357.z, min(1f, ((_e359.w * 0.01f) / abs(_e363))));
    } else {
        local_10 = vec4(0f);
    }
    let _e374 = local_10;
    ...
    let _e376 = color;
    let _e377 = tint_4;
    let _e378 = mergeColor(_e376, _e377);
    let _e379 = colorShadow_1;
    let _e380 = _e379.xyz;
    let _e381 = colorShadow_1;
    let _e383 = shadow;
    let _e389 = mergeColor(_e378, vec4<f32>(_e380.x, _e380.y, _e380.z, (_e381.w * _e383)));
    let _e390 = glow_2;
    let _e391 = mergeGlow(_e389, _e390);
    color = _e391;
    let _e392 = d;
    let _e394 = outlineThickness_1;
    if (abs(_e392) < (_e394 * 0.5f)) {
        {
            let _e398 = color;
            let _e399 = colorOutline_1;
            let _e400 = mergeColor(_e398, _e399);
            color = _e400;
            shadow = 0f;
        }
    }
...
fn main_1() {
    ...
    let _e129 = global.U[21];
    let _e130 = _e129.xyz;
    let _e133 = global.U[22];
    let _e134 = _e133.xyz;
    let _e137 = global.U[23];
    let _e138 = _e137.xyz;
    let _e154 = global.U[24];
    let _e155 = _e154.xyz;
    let _e158 = global.U[25];
    let _e159 = _e158.xyz;
    let _e162 = global.U[26];
    let _e163 = _e162.xyz;
    let _e179 = global.U[27];
    let _e180 = _e179.xyz;
    let _e183 = global.U[28];
    let _e184 = _e183.xyz;
    let _e187 = global.U[29];
    let _e188 = _e187.xyz;
    let _e202 = basicInterpolatedShapes((_naga_inverse_3x3_f32(mat3x3<f32>(vec3<f32>(_e10.x, _e10.y, _e10.z), vec3<f32>(_e14.x, _e14.y, _e14.z), vec3<f32>(_e18.x, _e18.y, _e18.z))) * vec3<f32>(_e45.x, _e45.y, 1f)).xy, (((_e52 - vec2(0.5f)) * 2f) * vec2<f32>(_e60.x, 1f)), i32(_e67.x), i32(_e72.x), _e77.x, _e81.x, _e85.x, _e89, _e92.x, _e96.x, _e100.x, _e104.x, _e108.x, _e112, _e115, _e118, _e121, i32(_e124.x), mat3x3<f32>(vec3<f32>(_e130.x, _e130.y, _e130.z), vec3<f32>(_e134.x, _e134.y, _e134.z), vec3<f32>(_e138.x, _e138.y, _e138.z)), mat3x3<f32>(vec3<f32>(_e155.x, _e155.y, _e155.z), vec3<f32>(_e159.x, _e159.y, _e159.z), vec3<f32>(_e163.x, _e163.y, _e163.z)), mat3x3<f32>(vec3<f32>(_e180.x, _e180.y, _e180.z), vec3<f32>(_e184.x, _e184.y, _e184.z), vec3<f32>(_e188.x, _e188.y, _e188.z)));
    fragColor = _e202;
    return;
}
