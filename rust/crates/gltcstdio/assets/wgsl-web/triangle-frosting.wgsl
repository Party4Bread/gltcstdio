...
fn triangleFrosting(uv: vec2<f32>, outPos: vec2<f32>, intensity: f32, count: i32, randomSeed: f32, modelTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    let _e44 = uv_1;
    let _e45 = tf(_naga_inverse_3x3_f32(_e42), _e44);
    v_2 = _e45;
    loop {
        let _e49 = i;
        let _e50 = N;
        ...
        }
        {
            ...
            let _e64 = rand2relSeeded(vec2<f32>((_e56 * 10f), (_e59 + 2.221f)), _e63);
            offset = (_e64 - vec2(0.5f));
            let _e69 = v_2;
            let _e71 = offset;
            u_2 = ((_e69 + (200f * _e71)) * 0.5f);
            let _e77 = u_2;
            id = floor(_e77);
            let _e80 = id;
            center = (_e80 + vec2(0.5f));
            let _e85 = id;
            ...
            let _e99 = rand2relSeeded(vec2<f32>((_e89.x * 1.15f), (_e93.y * 2.55f)), _e98);
            rnd2_ = _e99;
            let _e101 = center;
            let _e102 = size;
            let _e103 = rnd;
            a_2 = (_e101 + (_e102 * _e103));
            let _e107 = center;
            let _e108 = size;
            let _e109 = rnd;
            b_2 = (_e107 + (_e108 * (fract((_e109 * 10f)) - vec2(0.5f))));
            let _e119 = center;
            let _e120 = size;
            let _e121 = rnd2_;
            c_2 = (_e119 + (_e120 * _e121));
            let _e125 = u_2;
            let _e126 = a_2;
            let _e127 = b_2;
            let _e128 = c_2;
            let _e129 = inTriangle(_e125, _e126, _e127, _e128);
            if _e129 {
                {
                    let _e130 = col;
                    ...
                    let _e136 = c_2;
                    let _e143 = offset;
                    let _e146 = tf(_e131, (((2f * ((_e133 + _e134) + _e136)) / vec2(3f)) - (200f * _e143)));
                    ...
                    let _e158 = c_2;
                    let _e165 = offset;
                    let _e168 = tf(_e153, (((2f * ((_e155 + _e156) + _e158)) / vec2(3f)) - (200f * _e165)));
                    let _e178 = textureSampleLevel(t_source, samp, ((vec2<f32>((_e146.x / _e150.x), _e168.y) / vec2(2f)) + vec2(0.5f)), 0f);
                    let _e179 = intensity_1;
                    col = mix(_e130, _e178, vec4(_e179));
                }
            }
        }
        continuing {
