...
fn weaveBorder(pos: vec2<f32>, outPos: vec2<f32>, border: f32, sourceDim: vec2<f32>, outDim: vec2<f32>, borderColor: vec4<f32>, variability_2: f32, randomSeed_2: f32, modelTransform: mat3x3<f32>) -> vec4<f32> {
    ...
    if (_e56 <= 0f) {
        ...
        let _e77 = textureSampleLevel(t_source, samp, _e75, 0f);
        return _e77;
    }
    let _e78 = outPos_1;
    let _e80 = outPos_1;
    angle_2 = atan2(_e78.y, _e80.x);
    let _e85 = pos_1;
    let _e86 = angle_2;
    let _e87 = B;
    let _e91 = B;
    ...
    let _e99 = local;
    let _e103 = variability_3;
    let _e104 = randomSeed_3;
    let _e105 = sinewaves(_e85, _e86, _e87, 2f, 1f, (0.1f * _e99), 0.5f, 20f, _e103, _e104);
    k_5 = (1f - _e105);
    let _e108 = k_5;
    if (_e108 == 0f) {
    ...
    let _e112 = borderColor_1;
    let _e113 = v_4;
    let _e117 = global.U[0];
    let _e120 = v_4;
    let _e129 = _mirror_wrap(((vec2<f32>((_e113.x / _e117.x), _e120.y) / vec2(2f)) + vec2(0.5f)));
    let _e131 = textureSampleLevel(t_source, samp, _e129, 0f);
    let _e132 = k_5;
    return mix(_e112, _e131, vec4(_e132));
}
