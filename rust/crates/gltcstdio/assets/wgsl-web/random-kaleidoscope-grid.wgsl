...
fn kaleidoscope(pos: vec2<f32>, outPos: vec2<f32>, spikeCount: i32, texTransform: mat3x3<f32>, blend: f32, randomSeed: f32, variability: f32) -> vec4<f32> {
                    ...
                    if (_e202 > 0f) {
                        {
                            ...
                            let _e345 = textureSampleLevel(t_source, samp, _e343, 0f);
                            col = _e345;
                            let _e347 = totalCol;
                            let _e348 = weight;
                            let _e349 = col;
                            totalCol = (_e347 + (_e348 * _e349));
                            let _e352 = totalWeight;
                            let _e353 = weight;
                            totalWeight = (_e352 + _e353);
                        }
                    }
                }
                continuing {
    ...
    let _e355 = totalCol;
    let _e356 = totalWeight;
    let _e359 = lighting;
    let _e360 = vec3(_e359);
    return ((_e355 / vec4(_e356)) * vec4<f32>(_e360.x, _e360.y, _e360.z, 1f));
}
