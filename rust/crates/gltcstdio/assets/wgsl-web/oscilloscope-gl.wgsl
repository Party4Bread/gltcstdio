...
fn oscilloscope(pos: vec2<f32>, outPos: vec2<f32>, intensity: f32, thickness: f32, angle: f32, color1_: vec4<f32>, color2_: vec4<f32>, sourceDim: vec2<f32>) -> vec4<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e113 = textureSampleLevel(t_source, samp, _e111, 0f);
            c_2 = _e113;
            let _e115 = c_2;
            let _e117 = c_2;
            let _e120 = c_2;
            val = ((_e115.x + _e117.y) + _e120.z);
            let _e124 = acc;
            let _e125 = weight;
            let _e126 = val;
            acc = (_e124 + (_e125 * _e126));
            let _e129 = acc;
            if (_e129 >= 1f) {
                {
                    let _e132 = p_2;
                    ...
                    let _e137 = dd;
                    let _e138 = dd;
                    bestL = min(_e136, dot(_e137, _e138));
                    acc = 0f;
                }
            }
            let _e142 = p_2;
    ...
    let _e147 = radius;
    let _e149 = bestL;
    k_1 = smoothstep(_e147, 0f, sqrt(_e149));
    let _e153 = pos_1;
    let _e157 = global.U[0];
    let _e160 = pos_1;
    let _e169 = _mirror_wrap(((vec2<f32>((_e153.x / _e157.x), _e160.y) / vec2(2f)) + vec2(0.5f)));
    let _e171 = textureSampleLevel(t_source, samp, _e169, 0f);
    bkgCol = _e171;
    let _e173 = bkgCol;
    let _e175 = color2_1;
    let _e177 = color2_1;
    let _e180 = mix(_e173.xyz, _e175.xyz, vec3(_e177.w));
    let _e181 = bkgCol;
    lineColor = vec4<f32>(_e180.x, _e180.y, _e180.z, _e181.w);
    let _e188 = bkgCol;
    let _e190 = color1_1;
    let _e192 = color1_1;
    let _e195 = mix(_e188.xyz, _e190.xyz, vec3(_e192.w));
    let _e196 = bkgCol;
    backColor = vec4<f32>(_e195.x, _e195.y, _e195.z, _e196.w);
    let _e203 = backColor;
    let _e204 = lineColor;
    let _e205 = k_1;
    return mix(_e203, _e204, vec4(clamp(_e205, 0f, 1f)));
}
