/* @ts-self-types="./gltcstdio_wasm.d.ts" */
...
export class Filters {
    static __wrap(ptr) {
        const obj = Object.create(Filters.prototype);
        obj.__wbg_ptr = ptr;
        FiltersFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FiltersFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_filters_free(ptr, 0);
    }
    /**
     ...
     */
    cache_stats() {
        const ret = wasm.filters_cache_stats(this.__wbg_ptr);
     ...
     */
    clear_inputs() {
        wasm.filters_clear_inputs(this.__wbg_ptr);
    }
    /**
     ...
     */
    compile_check() {
        const ret = wasm.filters_compile_check(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    forget_cached() {
        wasm.filters_forget_cached(this.__wbg_ptr);
    }
    /**
     ...
     */
    forget_stages() {
        wasm.filters_forget_stages(this.__wbg_ptr);
    }
    /**
     ...
     */
    render(filter_id, rgba, width, height, params) {
        ...
        var ptr2 = isLikeNone(params) ? 0 : passStringToWasm0(params, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.filters_render(this.__wbg_ptr, ptr0, len0, ptr1, len1, width, height, ptr2, len2);
        return ret;
    }
    /**
     ...
     * @returns {Promise<Uint8Array>}
     */
    render_graph(graph, rgba, width, height) {
        const ptr0 = passStringToWasm0(graph, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.filters_render_graph(this.__wbg_ptr, ptr0, len0, ptr1, len1, width, height);
        return ret;
    }
    /**
     ...
     * @returns {Promise<Uint8Array>}
     */
    render_preset(filter_id, rgba, width, height, preset) {
        const ptr0 = passStringToWasm0(filter_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.filters_render_preset(this.__wbg_ptr, ptr0, len0, ptr1, len1, width, height, ptr2, len2);
        return ret;
    }
    /**
     ...
     * @param {number} height
     */
    set_input(names, rgba, width, height) {
        const ptr0 = passArrayJsValueToWasm0(names, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.filters_set_input(this.__wbg_ptr, ptr0, len0, ptr1, len1, width, height);
    }
}
if (Symbol.dispose) Filters.prototype[Symbol.dispose] = Filters.prototype.free;
 ...
 */
export function describe(filter_id) {
    const ptr0 = passStringToWasm0(filter_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string | undefined}
 */
export function graph_of(filter_id) {
    const ptr0 = passStringToWasm0(filter_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.graph_of(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
        v2 = getStringFromWasm0(ret[0], ret[1]);
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
 ...
 * @returns {string}
 */
export function list_filters() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.list_filters();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string | undefined}
 */
export function raw_graph_of(filter_id) {
    const ptr0 = passStringToWasm0(filter_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.raw_graph_of(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
        v2 = getStringFromWasm0(ret[0], ret[1]);
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_error_a41f619cb7feb99f: function(arg0) {
        ...
        __wbg_filters_new: function(arg0) {
            const ret = Filters.__wrap(arg0);
            return ret;
        },
        ...
        __wbg_lost_ce93d60f4c362075: function(arg0) {
            const ret = arg0.lost;
            return ret;
        },
        ...
        __wbg_message_90798d711180d0db: function(arg0, arg1) {
            const ret = arg1.message;
            const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        ...
        __wbg_new_typed_cceaf62d8d95e9f2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_reason_ebcb41764ba9b143: function(arg0) {
        ...
        __wbg_set_onuncapturederror_03bbe973a93f8773: function(arg0, arg1) {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true_);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_99990be5c2a92d37___JsError___true_);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true__2);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./gltcstdio_wasm_bg.js": import0,
    };
}

function wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true_(arg0, arg1, arg2) {
    wasm.wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true_(arg0, arg1, arg2);
}

function wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true__2(arg0, arg1, arg2) {
    wasm.wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue______true__2(arg0, arg1, arg2);
}

function wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_99990be5c2a92d37___JsError___true_(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___wasm_bindgen_99990be5c2a92d37___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_99990be5c2a92d37___JsError___true_(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_99990be5c2a92d37___convert__closures_____invoke___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined___js_sys_269b0a67d5f48475___Function_fn_wasm_bindgen_99990be5c2a92d37___JsValue_____wasm_bindgen_99990be5c2a92d37___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
...
const FiltersFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_filters_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gltcstdio_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
